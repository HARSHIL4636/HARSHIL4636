              ...
              <li class="nav-item dropdown outline">
                <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown"> SHOES </a>
                 <ul class="dropdown-menu text-center mt-1">
                    <li><a class="dropdown-item fs-5" href="SPORTS.php" style="font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman', serif;"> SPORTS </a></li>
                    <li><a class="dropdown-item fs-5" href="CROCS.html" style="font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman', serif;"> CROCS </a></li>
                    <li><a class="dropdown-item fs-5" href="Formal.php" style="font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman', serif;"> FORMAL </a></li>
    ...
    if ($result->num_rows > 0) {
      ...
      while($row = $result->fetch_assoc()) {
        if($row['EMAIL']===$_SESSION['email'])
        {
            ...
            { ?>
                  <li class=" me-1 outline nav-item d-inline-flex">
            ...
            <li class="me-2 outline nav-item d-inline-flex">
              <div class='text-light '>
                ...
                <button type="submit" name='LOGOUT' class='mt-1  btn btn-sm text-light'>LOGOUT</button>
                </form>
